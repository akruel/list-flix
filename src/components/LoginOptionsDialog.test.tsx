...
describe("LoginOptionsDialog", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      setup: () =>
        mocks.signInWithGoogle.mockRejectedValue(new Error("google failed")),
      shouldError: true,
    },
  ...
  it("opens and closes email input", async () => {
    ...
    await userEvent.click(
      screen.getByRole("button", { name: /Entrar com Email/i }),
    );
  ...
  it.each([
    ...
    },
    {
      ...
      setup: () =>
        mocks.signInWithOtp.mockRejectedValue(new Error("otp failed")),
      shouldClose: false,
      shouldError: true,
    },
