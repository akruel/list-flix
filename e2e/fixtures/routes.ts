...
export const SCENARIO_IDS = {
  ...
  HOME_MEDIA_TYPE_FILTERS: "HOME_MEDIA_TYPE_FILTERS",
  ACTIVITY_FEED_RENDER: "ACTIVITY_FEED_RENDER",
  ACTIVITY_FEED_EMPTY_STATE: "ACTIVITY_FEED_EMPTY_STATE",
  ACTIVITY_FEED_SHOWS_LIST_EVENT: "ACTIVITY_FEED_SHOWS_LIST_EVENT",
  ACTIVITY_FEED_LOAD_MORE: "ACTIVITY_FEED_LOAD_MORE",
  ACTIVITY_FEED_LOAD_MORE_ERROR: "ACTIVITY_FEED_LOAD_MORE_ERROR",
  ACTIVITY_FEED_INITIAL_ERROR_RETRY: "ACTIVITY_FEED_INITIAL_ERROR_RETRY",
  ACTIVITY_FEED_REFRESH_RESETS: "ACTIVITY_FEED_REFRESH_RESETS",
